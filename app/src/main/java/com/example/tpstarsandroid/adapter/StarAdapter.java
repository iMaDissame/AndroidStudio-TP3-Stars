package com.example.tpstarsandroid.adapter;
...
import com.example.tpstarsandroid.service.StarService;
...
public class StarAdapter extends RecyclerView.Adapter<StarAdapter.StarViewHolder> implements Filterable {
    ...
    public StarViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(this.context).inflate(R.layout.activity_star_item, viewGroup, false);
    ...
    public int getItemCount() {
        Log.d(TAG, "Nombre d'éléments dans l'adaptateur: " + starsFilter.size());
        return starsFilter.size(); // On retourne la taille de la liste filtrée
    }
    ...
    // Classe NewFilter qui effectue le filtrage sur la liste des étoiles
    public class NewFilter extends Filter {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            mAdapter.notifyDataSetChanged(); // Notifie l'adaptateur que la liste a été mise à jour
        }
    }
}
